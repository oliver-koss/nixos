...
Rectangle {
    ...
    FontLoader {
        id: myfontNormal
        source: "./assets/LiberationSans-Regular.ttf"
    }

    FontLoader {
        id: myfontBold
        source: "./assets/LiberationSans-Bold.ttf"
    }
    ...
    Image {
        ...
        Text {
            ...
            Text {
                ...
                color : "#00456a"
                text: Qt.formatDateTime(container.dateTime, "ddd d MMM - hh:mm:ss")
                font.pointSize: 20
                font.family: myfontBold.name
                font.bold: true
            }
